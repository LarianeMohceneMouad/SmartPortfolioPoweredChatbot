...
export default function ContactForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('🤖 Sending contact form to webhook:', webhookUrl)
...
*This was submitted from the contact form on the portfolio website. Please respond to this inquiry about Mohcene's work and expertise.*`
      ...
      console.log('📤 Sending formatted message to chatbot:', message)
      ...
      try {
        ...
        console.log('✅ Webhook responded but no JSON returned (this is often normal)')
        result = { success: true }
      }
      ...
      if (error.message.includes('Backend server is not running')) {
        console.error('💡 Solution: Run "npm start" in the backend folder')
